...
let m1000rr = document.querySelector(".m1000rr-img")
let g310rr = document.querySelector(".g310rr-img")
let m1000rr1 = document.querySelector("#m1000rr-img")
let g310rr1 = document.querySelector("#g310rr-img")

m1000rr.onclick = () => {
    window.location.href="m 1000 rr/m 1000 rr.html"
}

g310rr.onclick = () => {
    window.location.href="g310rr/g310rr.html"
}
...
mumbai.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="62,42,466")
