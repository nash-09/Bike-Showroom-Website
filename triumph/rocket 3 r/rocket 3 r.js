...
mumbai.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="27,12,986")
...
delhi.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="24,49,106")
...
rajasthan.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="26,20,715")
...
hydrabad.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="25,37,366")
...
bangalore.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="27,14,366")
