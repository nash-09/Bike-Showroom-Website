...
mumbai.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="16,91,380")
...
delhi.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="14,81,090")
...
rajasthan.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="16,19,215")
...
hydrabad.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="15,51,000")
...
bangalore.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="15,44,453")
