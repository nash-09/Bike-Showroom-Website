...
let panigale = document.querySelector(".panigale-img")
let monster = document.querySelector(".monster-img")
let panigale1 = document.querySelector("#panigale-img")
let monster1 = document.querySelector("#monster-img")

panigale.onclick = () => {
    window.location.href="panigale/panigale.html"
}
