...
let value3 = input3.value;
    ...
    if(value1 === "" || value2 === "" || value3 === ""){
        alert("Please fill the form")
            ...
            alert("Please check the checkbox of Terms & Conditions, Vistior Agreement and Privacy Policy")
        }
    else{
        alert("AD Submitted! Your bike listing is now live on our website. ")
        location.reload();
    }
}
