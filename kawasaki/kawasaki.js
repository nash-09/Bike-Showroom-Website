...
let kawasaki = document.querySelector(".ducati")
...
let h2sx = document.querySelector(".h2-sx-img")
let z900 = document.querySelector(".z900-img")
let h2sx1 = document.querySelector("#h2-sx-img")
let z9001 = document.querySelector("#z900-img")

h2sx.onclick = () => {
    window.location.href="ninja h2 sx/ninja h2 sx.html"
}

z900.onclick = () => {
    window.location.href="z 900/z 900.html"
}
...
mumbai.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="41,88,246")
    monsterAmt.forEach(el => el.innerText="11,86,320")
    ducatiPrice.forEach(el => el.innerText="On-Road Price Mumbai")
}
delhi.onclick = () => {
    alert("Check the On-Road Price in Delhi")
    panigaleAmt.forEach(el => el.innerText="37,14,620")
    monsterAmt.forEach(el => el.innerText="10,72,080")
    ducatiPrice.forEach(el => el.innerText="On-Road Price Delhi")
}
rajasthan.onclick = () => {
    alert("Check the On-Road Price in Rajasthan")
    panigaleAmt.forEach(el => el.innerText="40,61978")
    monsterAmt.forEach(el => el.innerText="11,87,509")
    ducatiPrice.forEach(el => el.innerText="On-Road Price Rajasthan")
}
hydrabad.onclick = () => {
    alert("Check the On-Road Price in Hydrabad")
    panigaleAmt.forEach(el => el.innerText="39,91,000")
    monsterAmt.forEach(el => el.innerText="11,29,000")
    ducatiPrice.forEach(el => el.innerText="On-Road Price Hydrabad")
}
bangalore.onclick = () => {
    alert("Check the On-Road Price in Bangalore")
    panigaleAmt.forEach(el => el.innerText="37,96,107")
    monsterAmt.forEach(el => el.innerText="11,10,160")
