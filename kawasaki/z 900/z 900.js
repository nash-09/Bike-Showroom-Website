...
mumbai.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="11,86,320")
...
delhi.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="10,72,080")
...
rajasthan.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="11,29,000")
...
hydrabad.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="11,10,160")
...
bangalore.onclick = () => {
    ...
    panigaleAmt.forEach(el => el.innerText="11,87,509")
